...
const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    icon: Schedule,
    children: [
      { id: 'availability-rules', label: 'Rules', path: '/availability/rules', icon: Schedule },
      { id: 'availability-overrides', label: 'Overrides', path: '/availability/overrides', icon: Schedule },
      { id: 'availability-blocked', label: 'Blocked Times', path: '/availability/blocked', icon: Schedule },
      { id: 'availability-buffer', label: 'Buffer Settings', path: '/availability/buffer', icon: Settings },
      { id: 'availability-stats', label: 'Statistics', path: '/availability/stats', icon: Analytics },
    ],
  },
  {
    id: 'integrations',
